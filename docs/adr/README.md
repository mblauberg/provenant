...
2026-08-02; ADR 0021 was ratified on 2026-08-29. Pre-ADR-0020 implementation
...
| [0003](0003-modular-monolith-complete-existing-seams.md) | Modular monolith; complete existing seams | Historical implementation superseded by ADR 0020; anti-scaffolding principle retained |
...
| [0009](0009-standalone-semantic-specifications.md) | Standalone semantic specifications | Accepted (amended 2026-07-28 by ADR 0017) |
| [0010](0010-lifecycle-receipt-authority-distinct-trust-boundary.md) | The lifecycle receipt authority is a trust boundary distinct from provider authority compilation | Historical implementation superseded by ADR 0020; vocabulary boundary retained |
...
| [0017](0017-specifications-own-non-derivable-intent.md) | Specifications own non-derivable intent only | Accepted; daemon-era schema example historical |
