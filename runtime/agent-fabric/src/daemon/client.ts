...
export type DaemonStartOptions = {
  ...
  /** Generated by the current build/warm path; test callers may pin a fixture identity. */
...
async function privateDaemonHandshake(
  ...
  if (discovery.receipt.runtimeBuildIdentity !== expectedRuntimeBuildIdentity) {
    return {
      status: "unavailable",
      reason: "stale",
      message: discovery.receipt.runtimeBuildIdentity === undefined
  ...
  return {
    ...
    runtimeBuildIdentity: discovery.receipt.runtimeBuildIdentity,
  };
}
