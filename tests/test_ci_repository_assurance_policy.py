...
# Fabric tests execute exactly these repo files outside runtime/agent-fabric.
# The allowlist is exact by design: adding an executed dependency means adding
# it here deliberately, and nothing else in docs/ or skills/ may path-trigger a
# non-harness job.
...
def test_ci_runs_complete_harness_and_fabric_gates() -> None:
    ...
    assert build_types_index < generated_check_index < build_index < status_index
